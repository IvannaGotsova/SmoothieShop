    ...
    public class SmoothieController : Controller
    {
        ...
        public async Task<IActionResult> SmoothieIngredients(int id)
        {
            ...
            try
            {
                ...
                TempData["message"] = $"Here you can see all ingredients by smoothie";
        ...
        public async Task<IActionResult> SmoothieMenus(int id)
        {
            ...
            try
            {
                ...
                TempData["message"] = $"Here you can see all menus by smoothie";
        ...
        public async Task<IActionResult> SmoothieOrders(int id)
        {
            ...
            try
            {
                ...
                TempData["message"] = $"Here you can see all orders by smoothie";
        ...
        public async Task<IActionResult> SmoothiesCustomer(int id)
        {
            ...
            try
            {
                ...
                TempData["message"] = $"Here you can see all smoothies by customer";
